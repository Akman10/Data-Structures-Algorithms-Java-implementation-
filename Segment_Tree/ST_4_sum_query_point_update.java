...
class ST_4_sum_query_point_update
{
	public static void main(String[] args)throws Exception{ new ST_4_sum_query_point_update().run();} 
	...
	void solve() throws Exception
	{
		...
		for (int i = 0; i < Q; i++) {
			...
			else
			{
				int L=ni();
				int R=ni();
				out.println(sum(1,0,N-1,L-1,R-1));
			}
		}
	}
